...
class Menu:
    def __init__(self, screen, draw_text, draw_button, draw_background):
        self.screen = screen
        self.draw_text = draw_text
        self.draw_button = draw_button
        self.draw_background = draw_background

    def main_menu(self, set_state, quit_game):
        ...
        self.draw_button("Quit",         WIDTH // 2 - 125, 410, 250, 50, BUTTON_RED,    quit_game)